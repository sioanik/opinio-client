            ...
            <div className="p-6">
                ...
                <div className="mt-4">
                    <div className="flex items-center">
                        <div className="flex items-center">
                            <img className="object-cover h-10 rounded-full" src={post.author_image} alt="Avatar" />
                ...
                <div className="flex items-center justify-around mt-4">
                    <div className="flex gap-8">
                        <button onClick={handleUpVote} className="btn btn-circle btn-outline text-white bg-lime-600 btn-xs"><FaThumbsUp /></button>
                        <button onClick={handleDownVote} className="btn btn-circle text-white bg-rose-600 btn-outline btn-xs"><FaThumbsDown /></button>
                    </div>
                    <div>
                        <div className="flex mt-1 gap-8 items-center justify-between">
                            <div className="Demo__some-network">
                                <FacebookShareButton disabled={!user} url={shareUrl} className="Demo__some-network__share-button">
